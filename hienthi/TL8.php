<?php
require "../db.php";
$sql8 =" select * from sach as a join theloaisach as b on a.idtheloai=b.idtheloai  where b.idtheloai='8'";
        ...
        if ($rs8->num_rows) {
            ...
            <div class="col-lg-4 mt-4 mb-4">
                    ...
                    <div class="card">
                        ...
                        <!-- Card image -->
                        <div class="view overlay"  title='.$row8['tensach'].'>
                        ...
                        <!-- Card footer gia-->
                            <div class="card-footer pb-0">
                                ...
                                <div class="row mb-0">
                                    ...
                                    <span class="float-left m-1 center-element text-info"><strong>'. number_format($row8["gia"]) .' đ</strong></span>
