<?php
require "../db.php";
$sql48 =" select * from sach as a join theloaisach as b on a.idtheloai=b.idtheloai  where b.idtheloai='48'";
$rs48= mysqli_query($conn,$sql48);
//$row48= mysqli_fetch_assoc($rs48);
//var_dump($row);
...
<div class="container mt-5 pt-3">
    ...
    <div class="row mt-5 mb-5 pt-5 pb-5">
        ...
        <?php
            while ($row48 = mysqli_fetch_assoc($rs48)) {
                $linkhinh = "http://localhost:8080/CT271/img/bookimg/" . $row48['hinhanh'];
                echo '
            ...
            <div class="col-lg-4 mt-4 mb-4">
                    ...
                    <div class="card">
                        ...
                        <!-- Card image -->
                        <div class="view overlay"  title=' . $row48['tensach'] . '>

                                    <img src=' . $linkhinh . ' alt="Hình Ảnh Sách" style="width: 330px; height: 350px; margin: 1em auto; padding-top: 1em;">

                            <a href="http://localhost:8080/CT271/khachhang/sanpham/hienthisp.php?idsach=' . $row48['idsach'] . ' " 
                                title=' . $row48['tensach'] . ' />
                        ...
                        <div class="card-body" style="height: 5em;">
                            ...
                            <h5 class="card-title mb-1">
                                <strong>
                                    <a href="http://localhost:8080/CT271/khachhang/sanpham/hienthisp.php?idsach=' . $row48['idsach'] . ' " 
                                        class="dark-grey-text font-small font-weight-bolder"  />' . $row48['tensach'] . '</a>
                                </strong>
                            </h5>
                        ...
                        <!-- Card footer gia-->
                            <div class="card-footer pb-0">
                                ...
                                <div class="row mb-0">
                                    ...
                                    <span class="float-left m-1 center-element text-info"><strong>' . number_format($row48["gia"]) . ' đ</strong></span>
