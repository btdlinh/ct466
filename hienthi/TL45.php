<?php
require "../db.php";
$sql45 =" select * from sach as a join theloaisach as b on a.idtheloai=b.idtheloai  where b.idtheloai='45'";
$rs45= mysqli_query($conn,$sql45);
//$row45= mysqli_fetch_assoc($rs45);
//var_dump($row);
        ...
        while ($row45 = mysqli_fetch_assoc($rs45)) {
            ...
            <div class="col-lg-4 mt-4 mb-4">
                    ...
                    <div class="card">
                        ...
                        <!-- Card image -->
                        <div class="view overlay"  title='.$row45['tensach'].'>
                        ...
                        <!-- Card footer gia-->
                            <div class="card-footer pb-0">
                                ...
                                <div class="row mb-0">
                                    ...
                                    <span class="float-left m-1 center-element text-info"><strong>'. number_format($row45["gia"]) .' đ</strong></span>
