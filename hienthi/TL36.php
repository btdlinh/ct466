<?php
require "../db.php";
$sql36 =" select * from sach as a join theloaisach as b on a.idtheloai=b.idtheloai  where b.idtheloai='36'";
$rs36= mysqli_query($conn,$sql36);
//var_dump($row);
...
<div class="container mt-5 pt-3">
    ...
    <div class="row mt-5 mb-5 pt-5 pb-5">
        ...
        <?php
        //        if ($rs13->num_rows) {
        while ($row36 = mysqli_fetch_assoc($rs36)) {
            $linkhinh = "http://localhost:8080/CT271/img/bookimg/" . $row36['hinhanh'];
            echo '
            ...
            <div class="col-lg-4 mt-4 mb-4">
                    ...
                    <div class="card">
                        ...
                        <!-- Card image -->
                        <div class="view overlay"  title='.$row36['tensach'].'>

                                    <img src='. $linkhinh.' alt="Hình Ảnh Sách" style="width: 330px; height: 350px; margin: 1em auto; padding-top: 1em;">

                            <a href="http://localhost:8080/CT271/khachhang/sanpham/hienthisp.php?idsach=' . $row36['idsach'] . ' " 
                                title='.$row36['tensach'].' />
                        ...
                        <div class="card-body" style="height: 5em;">
                            ...
                            <h5 class="card-title mb-1">
                                <strong>
                                    <a href="http://localhost:8080/CT271/khachhang/sanpham/hienthisp.php?idsach=' . $row36['idsach'] . ' " 
                                        class="dark-grey-text font-small font-weight-bolder"  />' . $row36['tensach'] . '</a>
                                </strong>
                            </h5>
                        ...
                        <!-- Card footer gia-->
                            <div class="card-footer pb-0">
                                ...
                                <div class="row mb-0">
                                    ...
                                    <span class="float-left m-1 center-element text-info"><strong>'. number_format($row36["gia"]) .' đ</strong></span>
