<?php
require "../db.php";
$sql50 =" select * from sach as a join theloaisach as b on a.idtheloai=b.idtheloai  where b.idtheloai='50'";
$rs50= mysqli_query($conn,$sql50);
//var_dump($row);
        ...
        while ($row50 = mysqli_fetch_assoc($rs50)) {
            ...
            <div class="col-lg-4 mt-4 mb-4">
                    ...
                    <div class="card">
                        ...
                        <!-- Card image -->
                        <div class="view overlay"  title='.$row50['tensach'].'>
                        ...
                        <!-- Card footer gia-->
                            <div class="card-footer pb-0">
                                ...
                                <div class="row mb-0">
                                    ...
                                    <span class="float-left m-1 center-element text-info"><strong>'. number_format($row50["gia"]) .' đ</strong></span>
