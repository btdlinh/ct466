<?php
require "../db.php";
$sql39 =" select * from sach as a join theloaisach as b on a.idtheloai=b.idtheloai  where b.idtheloai='39'";
$rs39= mysqli_query($conn,$sql39);
//var_dump($row);
...
<div class="container mt-5 pt-3">
    ...
    <div class="row mt-5 mb-5 pt-5 pb-5">
        ...
        <?php
        //        if ($rs13->num_rows) {
        while ($row39 = mysqli_fetch_assoc($rs39)) {
            $linkhinh = "http://localhost:8080/CT271/img/bookimg/" . $row39['hinhanh'];
            echo '
            ...
            <div class="col-lg-4 mt-4 mb-4">
                    ...
                    <div class="card">
                        ...
                        <!-- Card image -->
                        <div class="view overlay"  title='.$row39['tensach'].'>

                                    <img src='. $linkhinh.' alt="Hình Ảnh Sách" style="width: 330px; height: 350px; margin: 1em auto; padding-top: 1em;">

                            <a href="http://localhost:8080/CT271/khachhang/sanpham/hienthisp.php?idsach=' . $row39['idsach'] . ' " 
                                title='.$row39['tensach'].' />
                        ...
                        <div class="card-body" style="height: 5em;">
                            ...
                            <h5 class="card-title mb-1">
                                <strong>
                                    <a href="http://localhost:8080/CT271/khachhang/sanpham/hienthisp.php?idsach=' . $row39['idsach'] . ' " 
                                        class="dark-grey-text font-small font-weight-bolder"  />' . $row39['tensach'] . '</a>
                                </strong>
                            </h5>
                        ...
                        <!-- Card footer gia-->
                            <div class="card-footer pb-0">
                                ...
                                <div class="row mb-0">
                                    ...
                                    <span class="float-left m-1 center-element text-info"><strong>'. number_format($row39["gia"]) .' đ</strong></span>
