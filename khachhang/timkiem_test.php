<div class="container">
    <div class="row">
        ...
        if ($s) {
            ...
            $sqlGetCountPost = "SELECT idsach FROM sach WHERE status = '1' AND title LIKE '%$s%' OR keywords LIKE '%$s%' OR descr LIKE '%$s%'";
            ...
            $sql_get_news = "SELECT * FROM sach WHERE status = '1' AND title LIKE '%$s%' OR keywords LIKE '%$s%' OR descr LIKE '%$s%' ORDER BY idsach DESC LIMIT $start, $limit";
