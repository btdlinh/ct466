...
require "../sanpham/csdl_function.php";
...
if(isset($_SESSION['cart']) && (array_count_values($_SESSION['cart']))){
    ...
    <table class="table">
        ...
        foreach($_SESSION['cart'] as $isbn => $qty){
            ...
            ?>
            <tr>
                <td><?php echo $book['tensach'] . " by " . $book['tentacgia']; ?></td>
                <td><?php echo $book['gia'] ." đ"; ?></td>
                <td><?php echo $qty; ?></td>
                <td><?php echo  $qty * $book['gia'] ." đ"; ?></td>
            </tr>
        <?php } ?>
        <tr>
            <th>&nbsp;</th>
            ...
            <th><?php echo $_SESSION['total_price'] ." đ"; ?></th>
        </tr>
        <tr>
            <td>Shipping</td>
            <td>&nbsp;</td>
