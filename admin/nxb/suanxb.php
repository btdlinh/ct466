...
// nxb
    ...
    // lấy idsach muốn sửa
    $idnxb = $_GET['idnxb'];
    $sql4 = "SELECT * FROM nha_xuat_ban WHERE nxb_id=$idnxb";
...
<section class="section card mb-5 align-itemsocation:dangnhap.ht-center " style="width: 60% ;margin:0 auto">
    ...
    echo "<form action=\"xulysuanxb.php?idnxb=".$idnxb."\" method=\"POST\" enctype=\"multipart/form-data\">";
    ?>
    <!--<form method="POST" onsubmit="return Validate()" enctype="multipart/form-data">-->
    <div class="card-body black-text">
        <!-- Section heading -->
        <h1 class="text-center my-5 h1" style="padding-top: 1.5em;">Cập Nhật Thông Tin Nhà Xuất Bản</h1>
                ...
                <div class="col-md-10">
                    ...
                    <div class="md-form">
                        <input type="text"
                               ...
                               class="form-control form-control-sm black-text"
                               name="diachinxb"
                               value="<?php echo $row4['nxb_diachi']?>"
