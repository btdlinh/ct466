...
<header>
    ...
    <section class="section card mb-5 align-items-center " style="width: 60% ;margin: auto; height: 40em;">
        <form action="xulythemdanhmuc.php" method="POST" onsubmit="return Validate()">
            <div class="card-body black-text" >

                <!-- Section heading -->
                <h1 class="text-center my-5 h1" style="padding-top: 3em;">Thêm Danh Mục</h1>
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="md-form">
                                <input
                                        ...
                                        name="tendanhmuc"
                                />
                                <label for="orangeForm-name" class="orangeForm-name black-text"> Tên Danh Mục</label>
                            </div>
                            <div>
...
<script>
    ...
    function Validate() {
        ...
        if (tenloai === "") {
            ...
            document.getElementById("tbdanhmuc").innerHTML = "";
        }
        return OK;
    }
