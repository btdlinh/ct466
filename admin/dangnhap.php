...
<!--                            <a class="dropdown-item waves-effect waves-light" href="http://localhost/CT466/admin.html">Đăng Nhập</a>-->
                ...
                <div class="row mt-6">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div id="carousel-thumb" class="carousel slide carousel-fade carousel-thumbnails" data-ride="carousel">
                            ...
                            <div class="row mt-3 mb-4 ml-5" style="margin: 2em; padding: 5em;">
                                <div class="md-form">
                                    <h1 class="logo "
                                        style="
                                                        /*padding-top: 0.2em;*/
                                    ...
                                    <p class="slogan" style="color: black; text-align: center; font-size: 1.5em">Đăng nhập vào tài khoản</p>
                                </div>
                                    ...
                                    <div class="card wow fadeIn" data-wow-delay="0.3s" >
                                        ...
                                        <div class="card-body w-100">
                                            ...
                                            <div class="md-form">
                                                ...
                                                />
                                                <label for="orangeForm-email" class="blue-grey-text">Email</label>
                                            </div>
                                            <div>
