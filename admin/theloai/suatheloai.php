...
$sql4 = "SELECT * FROM the_loai WHERE tl_id=$idtheloai";
...
<section class="section card mb-5 align-itemsocation:dangnhap.ht-center " style="width: 60%; margin:0 auto">
    ...
    echo "<form action=\"xulysuatheloai.php?idtheloai=".$idtheloai."\" method=\"POST\" enctype=\"multipart/form-data\">";
    ?>
    <!--<form method="POST" onsubmit="return Validate()" enctype="multipart/form-data">-->
    <div class="card-body black-text" style="height: 35em;">
        <!-- Section heading -->
        <h1 class="text-center my-5 h1" style="padding-top: 3em;">Cập Nhật Thông Tin Thể Loại</h1>
        <div style="width: 100%; margin-left: 2.5em;"> <!--canh giữa form-->
                ...
                <div class="col-md-10">
                    ...
                    <div class="md-form">
                        <input type="text"
                               ...
                               name="tentheloai"
                               value="<?php echo $row4['tl_tentheloai']?>"
                        />
                        <label for="form1" class="orangeForm-name black-text"> Tên Thể Loại</label>
                    </div>
            ...
            <!-- Grid column -->
            <button class="btn btn-outline-light-blue btn-rounded btn-block my-4 waves-effect z-depth-0 " type="submit" style="width: 75%; ">
                Lưu Lại
            </button>
        </div>
    </div>
...
<!-- Footer-->
<footer class="page-footer text-center text-md-left stylish-color-dark pt-0" style="margin-top: 6.6em;">
    ...
    <div class="footer-copyright py-3 text-center" >
        ...
        <div class="container-fluid">
            ...
            © 2013 Nhà Sách Trực tuyến: <a href="#"><strong> Hiraki.com</strong></a>
