                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown ml-3">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-cyan" aria-labelledby="navbarDropdownMenuLink-4">
                            ...
                            <a class="dropdown-item waves-effect waves-light" href="http://localhost:8080/CT271/admin/dangky.html">Đăng Ký</a>
                    ...
                    <div id="carousel-thumb" class="carousel slide carousel-fade carousel-thumbnails" data-ride="carousel">
                        ...
                        <div class="row mt-3 mb-4" style="margin: 2em; padding: 7em;">
                            <div class="md-form">
                                ...
                                <p class="slogan" style="color: black; text-align: center; font-size: 1.5em">Thông tin tài khoản</p>
                            </div>
...
<!--                    <br><br><br>-->
                <table id="dtMaterialDesignExample" class="table">
                    ...
                    // lấy id cần xem
                        $idad = $_GET['id'];
                        $sql4 = "SELECT * FROM admin WHERE id=$idad";
