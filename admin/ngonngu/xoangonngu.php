...
//} else exit();
$idnn=$_GET['idngonngu']; // lay bien idtheloai tren url (id can xoa)
$sql = "SELECT * FROM ngon_ngu  WHERE  $idnn=nn_id";
$result = $conn->query($sql); // lay dong du lieu dua vao mang
$sql = "DELETE FROM ngon_ngu  WHERE nn_id=$idnn";
...
<section class="pb-4 pt-5 mt-5">
    <div class="card text-center w-50" style="margin: 0 auto;">
        ...
        <div class="card-body">
            ...
            <a href="dsngonngu.php" target="_self" class="btn btn-primary">Xóa</a>
        </div>
    </div>
</section>
</html>