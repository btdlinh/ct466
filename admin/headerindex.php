        ...
        <ul class="custom-scrollbar">
            ...
            <li class="logo-sn waves-effect py-3">
                <div class="text-center">
                    <a href="#" class="pl-0">
                        <img src="http://localhost/CT466/image/logo.png" style="width: 80%;">
                    </a>
                </div>
            </li>
            ...
            <li>
                <div class="md-form mt-0 waves-light border-bottom border-info">
                    <a href="http://localhost/CT466/admin">
                    ...
                    <li>
                        <ul class="collapsible collapsible-accordion">
                            ...
                            <li><a class="collapsible-header waves-effect arrow-r"><i class="fas fa-chevron-right"></i> KHÁCH HÀNG<i class="fas fa-angle-down rotate-icon"></i></a>
                                <div class="collapsible-body">
                                    <ul>
                                        ...
                                        <li><a href="http://localhost/CT466/khachhang/xem_lienhe.php" class="waves-effect">Tư vấn khách hàng</a></li>
                            ...
                            <li><a class="collapsible-header waves-effect arrow-r"><i class="fas fa-chevron-right"></i> ĐƠN HÀNG<i class="fas fa-angle-down rotate-icon"></i></a>
                                <div class="collapsible-body">
                                    <ul>
                                        <li><a href="http://localhost/CT466/admin/donhang/quanlydonhang.php" class="waves-effect">Chi Tiết Đơn Hàng</a></li>
                                        <li><a href="http://localhost/CT466/admin/donhang/thongkedonhang.php" class="waves-effect">Quản Lý Đơn  Hàng</a></li>
                            ...
                            <!--                                <div class="collapsible-body">-->
                            <!--                                    <ul>-->
                            <!--                                        <li><a href="http://localhost/CT466/admin/hoadon/quanlyhoadon.php" class="waves-effect">Danh Sách Hóa Đơn</a></li>-->
                            <!--                                    </ul>-->
                            <!--                                </div>-->
                            <!--                            </li>-->
                            ...
                            <li><a class="collapsible-header waves-effect arrow-r"><i class="fas fa-chevron-right"></i> BÌNH LUẬN<i class="fas fa-angle-down rotate-icon"></i></a>
                                <div class="collapsible-body">
                                    <ul>
                                        <li><a href="http://localhost/CT466/admin/binhluan/binhluan.php" class="waves-effect">Quản Lý Bình Luận</a></li>
